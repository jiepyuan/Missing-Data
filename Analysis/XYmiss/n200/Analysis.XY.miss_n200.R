...
for (index in 1:200){
  ...
  file_path <- paste0("/scratch/your account/Data/XYmiss/", "n200", "/",
...
setwd('/scratch/your account/Result/XYmiss/n200')

# save the result matrix
filename <- paste('/scratch/your account/Result/XYmiss/n200/replace1.replace2.replace3.replace4.replace5.result.txt',sep='')
...
# save the result 
filename <- paste('/scratch/your account/Result/XYmiss/n200/replace1.replace2.replace3.replace4.replace5.parameter.txt',sep='')
