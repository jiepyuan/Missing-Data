...
for (index in 1:200){
  ...
  file_path <- paste0("/Data/XYZmiss/", "n50", "/",
...
setwd('/Result/XYZmiss/n50')

# save the result matrix
filename <- paste('/Result/XYZmiss/n50/replace1.replace2.replace3.replace4.replace5.result.txt',sep='')
...
# save the result 
filename <- paste('/Result/XYZmiss/n50/replace1.replace2.replace3.replace4.replace5.parameter.txt',sep='')
