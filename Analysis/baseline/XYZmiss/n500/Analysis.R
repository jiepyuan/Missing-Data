...
for (index in 1:200){
  ...
  file_path <- paste0("/Data/XYZmiss/", "n500", "/",
...
setwd('/Result/XYZmiss/n500')

# save the result matrix
filename <- paste('/Result/XYZmiss/n500/replace1.replace2.replace3.replace4.replace5.result.txt',sep='')
...
# save the result 
filename <- paste('/Result/XYZmiss/n500/replace1.replace2.replace3.replace4.replace5.parameter.txt',sep='')
