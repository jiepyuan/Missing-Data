...
for (index in 1:200){
  ...
  file_path <- paste0("/Data/Ymiss/", "n50", "/", 
...
setwd('/Result/Ymiss/n50')

# save the result matrix
filename <- paste('/Result/Ymiss/n50/replace1.replace2.replace3.replace4.result.txt',sep='')
...
# save the result 
filename <- paste('/Result/Ymiss/n50/replace1.replace2.replace3.replace4.parameter.txt',sep='')
