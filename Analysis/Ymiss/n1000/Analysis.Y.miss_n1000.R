...
for (index in 1:200){
  ...
  file_path <- paste0("/scratch/your account/Data/Ymiss/", "n1000", "/", 
                      "replace1", ".", "replace2", ".", "replace3", ".", "replace4", 
                      "/data", index, ".txt")
...
setwd('/scratch/your account/Result/Ymiss/n1000')

# save the result matrix
filename <- paste('/scratch/your account/Result/Ymiss/n1000/replace1.replace2.replace3.replace4.result.txt',sep='')
...
value1 <- sub("^b2\\.", "", replace_1)
value2 <- sub("^aux", "", replace_2)
value3 <- sub("^mr", "", replace_3)
value4 <- sub("^mt\\.", "", replace_4)

# define the parameter matrix
parameter_matrix[1, ] <- c(nrow(data), value1, value2, value3, value4, para_calculator(result_matrix, true_x1_est = 0.1, true_x2_est = as.numeric(value1)))
...
# save the result 
filename <- paste('/scratch/your account/Result/Ymiss/n1000/replace1.replace2.replace3.replace4.parameter.txt',sep='')
