...
relative_bias_columns <- c(
  "relative_bias_x1_fiml", 
  "relative_bias_x1_pmm_default", "relative_bias_x1_pmm_0.2", "relative_bias_x1_pmm_manual",
  "relative_bias_x1_norm_default", "relative_bias_x1_norm_0.2", "relative_bias_x1_norm_manual",  # moved norm before cart
  "relative_bias_x1_cart_default", "relative_bias_x1_cart_0.2", "relative_bias_x1_cart_manual"
)
...
for (N_value in sort(unique(df$N))) {
  ...
  # ggsave(filename = paste0("y_relative_bias_x1_n_", N_value, ".pdf"), plot = plot, device = cairo_pdf, units = "in", width = 15, height = 10)
  
  ggsave(filename = paste0("y_relative_bias_x1_n_", N_value, ".png"), plot = plot, units = "in", width = 15, height = 10, dpi = 600)
}
